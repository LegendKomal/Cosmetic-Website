...
const Product = () => {
    ...
    const load = async (shoudShow) => {
        ...
        try {
            let response = await fetch(`https://api-sugarcosmetics.vercel.app/api/products?category=${param.product}&filter=${filter.join('.')}&sort=${sort}`, {
                method: "GET",
            })
        ...
        <Box mb="50px">
            ...
            {banner && (
                <Flex bgImage={banner} h={["auto", "auto", "auto", "270px"]}>
                    <Flex w="100%" h="100%" backdropFilter="blur(10px)" justifyContent="center">
