...
const Navbar = ({ ad_display, set_ad_display }) => {
  ...
  return (
    ...
    >
      <Flex
        display={ad_display}
        borderBottom="1px solid rgba(17, 30, 26, 0.9)"
        bg="#000000"
        w="100%"
        p="7px"
        color="white"
      ...
      >
        ...
        <Heading
          ...
          w="100%"
          as="h1"
          fontSize={["9px", "12px", "15px", "15px"]}
          fontWeight="medium"
        >
          {" "}
          FREE Base Of Glory Pore Minimizing Primer on spend of Rs.999 &nbsp;{" "}
        </Heading>
        <Flex w="100%" justifyContent="flex-end" pr="30px">
          {" "}
          <RxCross1
            onClick={() => {
              set_ad_display("none");
      ...
      >
        ...
        >
          ...
          <Logo onClick={() => { navigate("/") }} h={"70px"} display={["block", "block", "none", "none"]} />

        </Flex>

        <Logo onClick={() => { navigate("/") }} h={"200px"} display={["none", "none", "block", "block"]} />
      ...
      >
        {nav_routes.map(({ name, path }, id) => {
          return (
            <NavLink
              className="nav_item hover-underline-animation"
              to={path}
              key={id}
            >
              {" "}
