...
const CardCarousel = ({ headingColor, bgImage, data: { title, data } }) => {
    ...
    const load = async () => {
        ...
        try {
            let response = await fetch(`https://api-sugarcosmetics.vercel.app/api/wishlist`, {
                method: "GET",
            });
    ...
    return (
        <Flex className='card_wrapper' h={["450px", "600px", "600px", "600px"]} pb="50px" bgColor="black" direction="column" justifyContent="center" alignItems="center">
            {data ?
                <>
