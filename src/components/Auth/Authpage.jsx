    ...
    return (
        <Flex>
            <Box width='1200px' height='100vh' display={["none", "none", "none", "flex"]} >
                <Image src='https://images.pexels.com/photos/1887624/pexels-photo-1887624.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' width='100%' height='100%' alt='Dan Abramov' />
            </Box>
            <Flex
