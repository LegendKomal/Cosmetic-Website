...
const DealsCarousel = ({ children, headingColor, data }) => {
    ...
    return (
        <Flex direction="column" className="deals_wrapper">
            <Flex w="100%" h="50px" justifyContent="center" alignItems="center" bgColor="black" gap="15px" mt="20px" whiteSpace="nowrap">
                <Box h="2px" w={["30px", "50px", "50px", "50px"]} bg="#000000"></Box>
